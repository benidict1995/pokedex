...
import com.benidict.pokedex.component.shimmer.ShimmerEffect
import com.benidict.pokedex.component.shimmer.ShimmerPokemonCard
...
fun HomeScreen(viewModel: HomeViewModel, onChoosePokemon: (String) -> Unit) {
    ...
    var showShimmerLoader by remember {
        mutableStateOf(true)
    }
